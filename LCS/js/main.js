var I;//i subscript line
var J;//j subscript column
var L;//Two-dimensional array
var A;
var B;
var TBODY;
var OL;
...
function setp(){
	addClass(TBODY.rows[I+2].cells[1],'select-char');
	solve(I,J);
}
...
function creatTable(row,col,str1,str2){
	...
	//initialize the first and second lines
	for(i=2;i<col+3;i++){
